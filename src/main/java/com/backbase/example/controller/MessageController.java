...
public class MessageController {
    ...
    public @ResponseBody String getGreeting() throws BadRequestException, InternalServerErrorException {
        return "Hello, World";
    }
    ...
    public void addMessage(@RequestBody String text, @RequestParam("chatName") String chatName) throws BadRequestException, InternalServerErrorException {
